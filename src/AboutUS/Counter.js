...
const CounterItem = ({ iconClass, number, text, delay }) => {
  ...
  return (
    <div ref={counterRef} className="counter-item mb-40 wow fadeInUp" data-wow-delay={delay} data-aos="fade-up">
      <div className="icon">
...
const StaticCounterItem = ({ iconClass, number, text, delay }) => (
  <div className="counter-item mb-40 wow fadeInUp" data-wow-delay={delay} data-aos="fade-up">
    <div className="icon">
      <i className={iconClass} />
    </div>
    <div className="text">
  ...
  return (
    <section className="counter-area counter-area-v1 pt-240 pb-90">
      <div className="container">
        ...
        <div className="row no-gutters" style={{ color: 'black' }}>
          {/* Animated Counters */}
